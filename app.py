...
st.markdown(
    """
    Use the sidebar to set GA parameters, generate new random locations, and run the GA solver.
    When you click "Run GA," the app will show the fitness curve and the optimized routes.
    """
)
...
if run_button:
    ...
    **🔢 Route Summary**
    ...
    - **Avg Distance/Vehicle:** `{total_dist / num_vehicles:.2f}`
    """)
